package com.appinsnap.aishrm.ui.fragments.statics.adapter
...
class StatisticsEmployeeAdapter(
    val context: Context,
    val list: List<EmployeedetailModelresponces>,
    val itemclick:onItemClick
) : RecyclerView.Adapter<StatisticsEmployeeAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): StatisticsEmployeeAdapter.ViewHolder {
        val layoutInflater = LayoutInflater.from(parent.context)
        val binding = EmployeeattendancestatusBinding.inflate(layoutInflater, parent, false)
        return StatisticsEmployeeAdapter.ViewHolder(binding)
    }

    override fun onBindViewHolder(holder: StatisticsEmployeeAdapter.ViewHolder, position: Int) {
        ...
        /*  if (liststatus) {
              if (listposition.value.contains("late")) {
                  ...
                  if (listposition.lastCheckOut == null) {
                      holder.binding.txtcheckouttimeemployee.text = "Check-out" + " " + "---"
                  } else {
        ...
        holder.itemView.setSafeOnClickListener {
           itemclick.onAttendanceStausClick(position)
        }
        val index = 0
        holder.binding.employeename.text = listposition.name
        var remarks = listposition.remarks?.split("C")
        var finalremarks = remarks?.get(0)

        if (finalremarks?.lowercase()!!.contains("absent")) {
...
//            listposition.value = "client"
        ...
        } else if (finalremarks.lowercase().contains("late")) {
            //      listposition.status = true
        ...
        } else if (finalremarks.lowercase().contains("work from home")) {
            //        listposition.status = true
        ...
        } else if (finalremarks.lowercase().contains("client")) {
            //  listposition.status = true
            //  listposition.value = "client"
            holder.binding.txtcheckouttimeemployee.visibility = View.VISIBLE
            holder.binding.txtcheckintimeemployee.visibility = View.VISIBLE
            holder.binding.employattendancestatus.setTextColor(Color.parseColor("#00bb33"))
            holder.binding.employattendancestatus.text = finalremarks
            if (listposition.lastCheckOut == null) {
                holder.binding.txtcheckouttimeemployee.text = ""
            } else {
        ...
        } else if (finalremarks.lowercase().contains("leave")) {
            //      listposition.status = true
            holder.binding.txtcheckouttimeemployee.visibility = View.GONE
            holder.binding.txtcheckintimeemployee.visibility = View.GONE
        ...
        else if(finalremarks.lowercase().contains("other"))
        {
            holder.binding.txtcheckouttimeemployee.visibility = View.VISIBLE
            holder.binding.txtcheckintimeemployee.visibility = View.VISIBLE
            if (listposition.lastCheckOut == null) {
            ...
            holder.binding.employattendancestatus.setTextColor(Color.parseColor("#ffffff"))
            holder.binding.employattendancestatus.text = finalremarks
            if (listposition.lastCheckOut == null) {
                holder.binding.txtcheckouttimeemployee.text = ""
            } else {
        ...
        if (listposition.designation != null) {
            if (listposition.designation!!.lowercase()
                    .contains("manager ") || listposition.designation!!.lowercase()
               ...
               else if(listposition.designation.toString().lowercase().contains("manager "))
                {
                    holder.binding.mcvemployeedesignation.visibility = View.VISIBLE
                    holder.binding.txtdesignation.text = "Manager"
                }
               else if(listposition.designation.toString().lowercase()=="project manager")
                {
                    ...
                    if (firstletter.toString()
                        ...
                        if (firstletter.toString()
                            ...
                            if (firstletter.toString()
                                ...
                                val color = Color.argb(255, 149, 25, 171)
                                holder.binding.mcvemployeename.setCardBackgroundColor(
                                    Color.parseColor(
                                        "#FF018786"
                                    )
                                )
                                ...
                                if (firstletter.toString()
                                        ...
                                        .lowercase() == "i" || firstletter.toString()
                                        .lowercase() == "k"
                                ) {
    ...
    interface onItemClick{
        fun onAttendanceStausClick(position: Int)
    }
